document.addEventListener("magicbox.init", function(e)
{
  ...
  var camera         = undefined,
      ...
      ballRadius     = 0.25,
      keyAxis        = [0, 0],
      ironTexture    = THREE.ImageUtils.loadTexture(manifest.namedAssets["ball"]),
      planeTexture   = THREE.ImageUtils.loadTexture(manifest.namedAssets["concrete"]),
      brickTexture   = THREE.ImageUtils.loadTexture(manifest.namedAssets["brick"]),
      gameState      = undefined,
